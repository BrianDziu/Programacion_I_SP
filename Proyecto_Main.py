...
# Musica y Sonidos
pygame.mixer.music.load("Programacion_I\Pygame\Sonidos\Waterworld - Map.mp3")
pygame.mixer.music.set_volume(0.1)

pygame.mixer.music.play(loops=-1)

# Imagenes
icono = pygame.image.load("Programacion_I/Pygame/Imagenes/destructor.png")
fondo = pygame.image.load("Programacion_I/Pygame/Imagenes/fondo_menu.jpg")
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.MOUSEBUTTONDOWN:
                ...
                if boton_inicio.collidepoint(coordenadas_click) == True:
                    ...
                    dicc_barcos = rellenar_tablero(matriz_valor, submarinos, destructores, cruceros, acorazados, dificultad)
