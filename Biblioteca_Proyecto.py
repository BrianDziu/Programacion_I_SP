...
def rellenar_tablero(matriz:list, submarinos:int, destructores:int, cruceros:int, acorazados:int, dificultad:int)-> list[dict]:
    '''
    ...
    de barcos requeridos y un entero con la dificultad.
